...
# Setup response data
response_data <- list(res_npc_gap = inla_data$npc_gap)#list(res_npc_gap = res_npc_gap)
...
save(africa_mesh, africa_spde, temporal_mesh_annual, m1, epsilon, file = "/mnt/efs/userdata/etan/mitn_outputs/outputs/INLA/model1_npc_complete_logmodel_gap.RData")
